...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Zulqarnain Haider — Virtual Assistant & Lead Generation Specialist" },
      { property: "og:description", content: "Reliable VA for lead generation, data entry, web research, CRM updates, and admin support." },
